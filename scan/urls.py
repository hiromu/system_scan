...
urlpatterns = patterns('',
    ...
    (r'^contests/(?P<contest_id>\d+)/problems/(?P<genre_id>\d+)/edit/(?P<problem_id>\d+)/preview/$', 'scan.views.problems.preview'),
    ...
    (r'^contests/(?P<contest_id>\d+)/problems/(?P<genre_id>\d+)/figures/(?P<problem_id>\d+)/get/$', 'scan.views.problems.get_figures'),
    (r'^contests/(?P<contest_id>\d+)/problems/(?P<genre_id>\d+)/figures/(?P<problem_id>\d+)/add/$', 'scan.views.problems.add_figure'),
    (r'^contests/(?P<contest_id>\d+)/problems/(?P<genre_id>\d+)/figures/(?P<problem_id>\d+)/del/(?P<figure_id>\d+)/$', 'scan.views.problems.delete_figure'),

    (r'^contests/(?P<contest_id>\d+)/marks/(?P<genre_id>\d+)/$', 'scan.views.marks.index'),
    (r'^contests/(?P<contest_id>\d+)/marks/(?P<genre_id>\d+)/(?P<problem_id>\d+)/$', 'scan.views.marks.problem'),
    (r'^contests/(?P<contest_id>\d+)/marks/(?P<genre_id>\d+)/(?P<problem_id>\d+)/(?P<answer_id>\d+)/$', 'scan.views.marks.mark'),
    (r'^contests/(?P<contest_id>\d+)/marks/(?P<genre_id>\d+)/(?P<problem_id>\d+)/finish/$', 'scan.views.marks.finish'),
