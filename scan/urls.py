...
urlpatterns = patterns('',
    ...
    url(r'^contests/(?P<contest_id>\d+)/problems/(?P<genre_id>\d+)/upload/$', 'scan.views.problems.upload'),
    url(r'^contests/(?P<contest_id>\d+)/problems/(?P<genre_id>\d+)/edit/(?P<problem_id>\d+)/$', 'scan.views.problems.edit'),
    url(r'^contests/(?P<contest_id>\d+)/problems/(?P<genre_id>\d+)/edit/(?P<problem_id>\d+)/update_point/$', 'scan.views.problems.update_point'),
